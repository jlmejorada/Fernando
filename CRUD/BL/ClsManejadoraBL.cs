...
namespace BL
{
    public class ClsManejadoraBL
    {
        ...
        {
            return ClsManejadoraDAL.BuscaPersonaDAL(id);
        }
        ...
        {
            return ClsManejadoraDAL.BorraPersonaDAL(id);
        }
        ...
        {
            return ClsManejadoraDAL.CreaPersonaDAL(persona);
        }
        ...
        {
            return ClsManejadoraDAL.EditaPersonaDAL(persona);
        }
    }
}
