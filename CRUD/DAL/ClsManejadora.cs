...
namespace DAL
{
    internal class ClsManejadora
    {
        ...
        public static bool CreaPersona(ClsPersona persona)
        {
            bool seCrea = false;
            ...
            try
            {
                ...
                miComando.CommandText = "INSERT INTO Persona (Nombre, Apellidos, Telefono, Foto, FechaNacimiento,IDDepartamento) " +
        ...
        public static bool EditaPersona(ClsPersona persona)
        {
            bool seEdita = false;
            ...
            try
            {
                ...
                miComando.Parameters.AddWithValue("@fecha", persona.FechaNacimiento);
                miComando.Parameters.AddWithValue("@dep", persona.IDDepartamento);
                miComando.CommandText = "UPDATE INTO Persona (Nombre, Apellidos, Telefono, Foto, FechaNacimiento,IDDepartamento) " +
                    "VALUES (@nombre, @apellidos, @tel, @dir, @fecha, @dep)";
