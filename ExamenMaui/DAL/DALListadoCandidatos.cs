...
namespace DAL
{
    public class DALListadoCandidatos
    {
        /// <summary>
        /// Funcion que saca los candidatos de una supuesta bdd
        /// </summary>
        /// <returns>List<ClsCandidato></returns>
        public static List<ClsCandidato> sacarCandidatosDAL()
        {
